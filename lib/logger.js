...
function log1(req, res, next) {
  //  console.log('class mylogger2============================');
    ...
    console.log('dt = ' + toYYYYMMDDHHMMSS(new Date()) + ', ' + ++glob.requestId + ', ' + logLevel +
    ', ip = ' + ip +
    ', url = ' + req.url
    );
    //console.log();
...
function log2(msg) {
    console.log('tt = ' + toYYYYMMDDHHMMSS(new Date())+ ', ' + glob.requestId+ ', ' + logLevel + ', ' + msg);
...
module.exports = {log1, log2, log3, logLevel};